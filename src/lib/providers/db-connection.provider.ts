...
import type { IDBConnection } from '../interfaces/db-connection.interface'
import type { DBRequestConfig } from '../interfaces/db-request-config.interface'
 ...
 * @module lib/providers/DBConnection
 */
